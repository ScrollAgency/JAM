const KanbanMeta = {
    ...
    importPath: "./plasmic-library/ui/Kanban",
    thumbnailUrl: `${process.env.NEXT_PUBLIC_PROJECT_URL}/library/Kanban.png`,
    ...
    props: {
        ...
        headerStyle: {
            type: "object",
            description: "Default styling options for column headers. You can also specify styles per column using the 'stylesParColonne' field (object mapping column name to style).",
            defaultValue: {
            ...
            fields: {
                ...
                stylesParColonne: {
                    type: "object",
                    description: "Mapping of column name to style object. Example: { 'À faire': { backgroundColor: '#f00' }, 'Terminé': { backgroundColor: '#0f0' } }",
                    fields: {
                        backgroundColor: { type: "string", description: "Background color for this column" },
                        textColor: { type: "string", description: "Text color for this column" }
                    },
                    advanced: true
                }
            }
