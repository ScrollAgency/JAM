...
export interface CalendarHerouiProps {
  value?: { start: string; end: string };
  showDefaultDate?: boolean;
  onDateChange?: (value: { start: string; end: string } | null) => void;
}

function CalendarHeroui_(props: CalendarHerouiProps, ref: HTMLElementRefOf<"div">) {
...
const CalendarHeroui = React.forwardRef(CalendarHeroui_);
export default CalendarHeroui;
