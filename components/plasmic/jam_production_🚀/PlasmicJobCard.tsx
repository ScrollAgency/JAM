...
export type PlasmicJobCard__VariantMembers = {};
export type PlasmicJobCard__VariantsArgs = {};
type VariantPropType = keyof PlasmicJobCard__VariantsArgs;
...
function PlasmicJobCard__RenderFunc(props: {
  variants: PlasmicJobCard__VariantsArgs;
  args: PlasmicJobCard__ArgsType;
  overrides: PlasmicJobCard__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__kD3Dt)}>
        <div className={classNames(projectcss.all, sty.freeBox__lvPyQ)}>
          <div className={classNames(projectcss.all, sty.freeBox__q1Yn)}>
            <div className={classNames(projectcss.all, sty.freeBox__q2DmR)}>
              <div className={classNames(projectcss.all, sty.freeBox__weg0R)}>
                <div
                  className={classNames(
                    projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___58Ggo)}>
                <IconPhMapPinIcon
            ...
            <div className={classNames(projectcss.all, sty.freeBox__pARq8)}>
              <div className={classNames(projectcss.all, sty.freeBox___1T0Xi)}>
                <div
      ...
      <div className={classNames(projectcss.all, sty.freeBox__lDrQm)}>
        <Button
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicJobCard__ArgProps,
          internalVariantPropNames: PlasmicJobCard__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicJobCard__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicJobCard";
  } else {
    func.displayName = `PlasmicJobCard.${nodeName}`;
  }
  return func;
}

export const PlasmicJobCard = Object.assign(
  // Top-level PlasmicJobCard renders the root element
  makeNodeComponent("root"),
  {
    ...
    internalArgProps: PlasmicJobCard__ArgProps
  }
);

export default PlasmicJobCard;
/* prettier-ignore-end */
