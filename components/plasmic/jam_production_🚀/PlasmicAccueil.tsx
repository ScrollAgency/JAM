      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            <div className={classNames(projectcss.all, sty.freeBox__cWnZj)}>
              <PlasmicLink__
                ...
                <Button
                  ...
                  onClick={async event => {
                    ...
                    if (
                      ...
                      typeof $steps["goToRegisterValidation"] === "object" &&
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className={classNames(projectcss.all, sty.freeBox__v7K4A)}>
                  <div
                  ...
                  >
                    <div
                      ...
                      className={classNames(projectcss.all, sty.filtersDesk)}
                    >
                      {(() => {
                        const child$Props = {
                          className: classNames(
                                    ...
                                    (async (value, option) => {
                                      ...
                                      if (
                                        ...
                                        typeof $steps["updateSalary"] ===
                                          "object" &&
                                        typeof $steps["updateSalary"].then ===
                                          "function"
                                      ) {
                                        $steps["updateSalary"] = await $steps[
                                          "updateSalary"
                                        ];
                                      }
                                    }).apply(null, eventArgs);
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__v56E6)}
                    >
                      <LoadingBoundary
            ...
            >
              ...
              >
                <SectionCard
                  ...
                  icon={generateStateValueProp($state, ["sectionCard", "icon"])}
                ...
                <SectionCard
                  ...
                  className={classNames("__wab_instance", sty.sectionCard2)}
                  description={generateStateValueProp($state, [
                    "sectionCard2",
                    "description"
                  ])}
                ...
                <SectionCard
                  ...
                  className={classNames("__wab_instance", sty.sectionCard3)}
                  description={generateStateValueProp($state, [
                    "sectionCard3",
                    "description"
                  ])}
          ...
          <Modal
            ...
            content={
              <div className={classNames(projectcss.all, sty.freeBox___0N4QT)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
                ...
                >
                  ...
                  >
                    ...
                    {(() => {
                      ...
                      >
                        <PhCheckBoldIcon
                          className={classNames(projectcss.all, sty.svg__bx0Wr)}
                          role={"img"}
                        />
                            ...
                            {(
                              hasVariant(globalVariants, "screen", "mobileOnly")
                                ? (() => {
                                    try {
                                      return (
                                        $state.jobObject.company_size != null
                                      );
                                    } catch (e) {
                                      if (
                                        e instanceof TypeError ||
                                ...
                                userArgs: {
                                  ...
                                  variables: [
                                    $steps.cv?.path.split("/")[1] != undefined
                                      ...
                                      : $queries.getCurrentUser.data[0].cv_file,
                    ...
                    >
                      ...
                      >
                        <TextInput
                          ...
                          defaultValue={(() => {
                            try {
                              return $queries.getCurrentUser.data[0].email;
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                                e?.plasmicType === "PlasmicUndefinedDataError"
                      ...
                      >
                        <TextInput
                          ...
                          defaultValue={(() => {
                            try {
                              return $queries.getCurrentUser.data[0].address;
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                                e?.plasmicType === "PlasmicUndefinedDataError"
                      ...
                      >
                        ...
                        >
                          <TextInput
                            ...
                            defaultValue={(() => {
                              try {
                                return $queries.getCurrentUser.data[0].city;
                              } catch (e) {
                                if (
                                  e instanceof TypeError ||
                                  e?.plasmicType === "PlasmicUndefinedDataError"
                      ...
                      <FormItemWrapper
                        ...
                        initialValue={(() => {
                          try {
                            return (
                              $queries.getCurrentUser.data[0].transport_mode ||
                              undefined
                            );
                          } catch (e) {
                            if (
                      ...
                      <FormItemWrapper
                        ...
                        initialValue={(() => {
                          try {
                            return (
                              $queries.getCurrentUser.data[0].skill || undefined
                            );
                          } catch (e) {
                            if (
                              e instanceof TypeError ||
                      ...
                      <FormItemWrapper
                        ...
                        initialValue={$queries.getCurrentUser?.data[0]?.level}
                      ...
                      >
                        <Select
                          ...
                          initialSelectedValue={(() => {
                            try {
                              return $queries.getCurrentUser.data[0].level;
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                                e?.plasmicType === "PlasmicUndefinedDataError"
                      ...
                      >
                        ...
                        >
                          ...
                          {(() => {
                            try {
                              return (
                                $queries.getCurrentUser.data[0].cv_file !== null
                              );
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
          ...
          <Modal
            ...
            closeOnBackdropClick={false}
            content={
              <div className={classNames(projectcss.all, sty.freeBox__ksAtE)}>
                {(() => {
                  const child$Props = {
...
const PlasmicDescendants = {
  ...
  screen2: ["screen2", "frame10", "frame11", "frame12", "frame21"],
  frame10: ["frame10", "frame11", "frame12", "frame21"],
  frame11: ["frame11"],
  frame12: ["frame12"],
  frame21: ["frame21"],
  mapJobs: [
