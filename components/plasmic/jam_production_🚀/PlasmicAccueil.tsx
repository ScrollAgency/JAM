                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <TextInput
                            ...
                            defaultValue={(() => {
                              try {
                                return $queries.currentUser.data[0].first_name;
                              } catch (e) {
                                if (
                                  e instanceof TypeError ||
                                  e?.plasmicType === "PlasmicUndefinedDataError"
                      ...
                      >
                        ...
                        >
                          <TextInput
                            ...
                            defaultValue={(() => {
                              try {
                                return $queries.currentUser.data[0].postal_code;
                              } catch (e) {
                                if (
                                  e instanceof TypeError ||
                                  e?.plasmicType === "PlasmicUndefinedDataError"
                      ...
                      <FormItemWrapper
                        ...
                        initialValue={(() => {
                          try {
                            return (
                              $queries.currentUser.data[0].transport_mode ||
                              undefined
                            );
                          } catch (e) {
                            if (
                      ...
                      <FormItemWrapper
                        ...
                        initialValue={(() => {
                          try {
                            return (
                              $queries.currentUser.data[0].skill || undefined
                            );
                          } catch (e) {
                            if (
                              e instanceof TypeError ||
                      ...
                      >
                        ...
                        >
                          ...
                          {(() => {
                            try {
                              return (
                                $queries.currentUser.data[0].cv_file !== null
                              );
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                      ...
                      >
                        <TextInput
                          ...
                          defaultValue={(() => {
                            try {
                              return $queries.currentUser.data[0].linkedin_url;
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
                                e?.plasmicType === "PlasmicUndefinedDataError"
                ...
                >
                  ...
                  >
                    <div
                      ...
                      className={classNames(projectcss.all, sty.joblistandbtn)}
                    >
                      <div
                                  ...
                                  try {
                                    return (() => {
                                      if ($state.isDiv1Visible == false) {
                                        ...
                                        $queries.jobOffers.data.length === 0
                                      ) {
                    ...
                    <div
                      ...
                      className={classNames(projectcss.all, sty.lastMinuteBtn)}
                    >
                      {(() => {
                        try {
                    ...
                    >
                      <MapBox
                        ...
                        markers={(() => {
                          try {
                            return (() => {
                              const jobOffers = $queries.jobOffers.data ?? [];
                              const applications =
