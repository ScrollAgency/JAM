...
import sty from "./PlasmicButton5.module.css"; // plasmic-import: PnWq9UnIML_r/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lihQ, {
          [sty.freeBoxcolor_neutral__lihQkc3B3]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__lihQ1RQqAJolj]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__lihQf2Wy7]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__lihQeiClf]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__lihQy4XmW]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__lihQYh2Tq]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__lihQ568Gd]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__lihQkzhTd]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__lihQaJolj]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__zUe7R, {
            [sty.freeBoxcolor_neutral__zUe7Rkc3B3]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__zUe7RXwEiF]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__zUe7Ry4XmW]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__zUe7R568Gd]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__zUe7RkzhTd]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__zUe7RaJolj]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__zUe7R4Vgi9Kc3B3]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___5SYhY)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__k1T28, {
            [sty.freeBoxiconEnd__k1T28A5WhR]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__k1T28Y4XmW]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__k1T28568Gd]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__k1T28KzhTd]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg___0GjvW)}
                role={"img"}
              />
            ),
