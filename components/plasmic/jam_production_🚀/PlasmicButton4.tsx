...
import sty from "./PlasmicButton4.module.css"; // plasmic-import: B7dWxs_AQDbs/css
    ...
    >
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.freeBox, {
          ...
          [sty.freeBoxtype_bordered]: hasVariant($state, "type", "bordered"),
          [sty.freeBoxtype_bordered_color_success]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
...
const PlasmicDescendants = {
  root: ["root", "softBackground", "border", "interactionEffect", "freeBox"],
