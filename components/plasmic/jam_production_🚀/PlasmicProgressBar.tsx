...
import { Step1Value, useStep1 } from "./PlasmicGlobalVariant__Step1"; // plasmic-import: 75pRE6NAcuQN/globalVariant
  ...
  return (
    <Stack__
      ...
      className={classNames(
        ...
        sty.progressBar,
        {
          [sty.progressBarglobal_step1_unnamedVariant]: hasVariant(
            globalVariants,
            "step1",
            "unnamedVariant"
          ),
