...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: RjZcZb_kakG7/css
...
export type PlasmicButton2__VariantsArgs = {
  color?: SingleChoiceArg<
    ...
    | "white"
  >;
  type?: SingleChoiceArg<"soft" | "bordered" | "actif">;
...
function PlasmicButton2__RenderFunc(props: {
  ...
  return (
    <BaseButton
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.roottype_actif]: hasVariant($state, "type", "actif"),
          ...
          [sty.roottype_bordered_color_muted]:
            hasVariant($state, "color", "muted") &&
            hasVariant($state, "type", "bordered"),
          [sty.roottype_bordered_color_transparent]:
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__meEhg, {
          [sty.freeBoxcolor_neutral__meEhg10BGd]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_transparent__meEhgQPfAo]: hasVariant(
            $state,
            "color",
            "transparent"
          ),
          [sty.freeBoxiconEnd__meEhgtPpZa]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__meEhgrlBu4]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxroundedFull__meEhgZYyPx]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__meEhgMzt7S]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__meEhgDIas]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__meEhgHdEow]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__meEhgvF3PU]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_actif__meEhg7Xl6P]: hasVariant(
            $state,
            "type",
            "actif"
          ),
          [sty.freeBoxtype_bordered__meEhgDihjl]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_transparent__meEhgDihjlQPfAo]:
            hasVariant($state, "color", "transparent") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          ...
          className={classNames(projectcss.all, sty.frame22, {
            ...
            [sty.frame22type_bordered]: hasVariant($state, "type", "bordered")
          })}
        />

        <div
          className={classNames(projectcss.all, sty.freeBox__yxw1O, {
            [sty.freeBoxcolor_neutral__yxw1O10BGd]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__yxw1O10BGdNeD]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxcolor_transparent__yxw1OQPfAo]: hasVariant(
              $state,
              "color",
              "transparent"
            ),
            [sty.freeBoxiconStart__yxw1OrlBu4]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__yxw1OMzt7S]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__yxw1OHdEow]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__yxw1OvF3PU]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_actif__yxw1O7Xl6P]: hasVariant(
              $state,
              "type",
              "actif"
            ),
            [sty.freeBoxtype_bordered__yxw1ODihjl]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__zl8Ku)}
                role={"img"}
              />
            ),
            ...
            className: classNames(sty.slotTargetStart, {
              ...
              [sty.slotTargetStarttype_actif]: hasVariant(
                $state,
                "type",
                "actif"
              ),
              ...
              [sty.slotTargetStarttype_bordered_color_muted]:
                hasVariant($state, "color", "muted") &&
                hasVariant($state, "type", "bordered"),
              [sty.slotTargetStarttype_bordered_color_transparent]:
                hasVariant($state, "color", "transparent") &&
                hasVariant($state, "type", "bordered"),
        ...
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetLabel, {
            ...
            [sty.slotTargetLabeltype_actif]: hasVariant(
              $state,
              "type",
              "actif"
            ),
            ...
            [sty.slotTargetLabeltype_bordered_color_muted]:
              hasVariant($state, "color", "muted") &&
              hasVariant($state, "type", "bordered"),
            [sty.slotTargetLabeltype_bordered_color_transparent]:
              hasVariant($state, "color", "transparent") &&
              hasVariant($state, "type", "bordered"),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__jiEDc, {
            [sty.freeBoxiconEnd__jiEDctPpZa]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__jiEDcMzt7S]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__jiEDcHdEow]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__jiEDcvF3PU]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_actif__jiEDc7Xl6P]: hasVariant(
              $state,
              "type",
              "actif"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <PictogramIcon
                className={classNames(projectcss.all, sty.svg__lkvlf)}
                role={"img"}
              />
            ),
            ...
            className: classNames(sty.slotTargetEnd, {
              ...
              [sty.slotTargetEndtype_bordered_color_muted]:
                hasVariant($state, "color", "muted") &&
                hasVariant($state, "type", "bordered"),
              [sty.slotTargetEndtype_bordered_color_transparent]:
                hasVariant($state, "color", "transparent") &&
                hasVariant($state, "type", "bordered"),
