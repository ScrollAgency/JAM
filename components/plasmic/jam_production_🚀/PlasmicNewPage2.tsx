...
import sty from "./PlasmicNewPage2.module.css"; // plasmic-import: n2hOExzm1qoT/css
...
function PlasmicNewPage2__RenderFunc(props: {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      {
        path: "resetPassword.repeatPassword",
        type: "private",
        variableType: "text",
        initFunc: ({ $props, $state, $queries, $ctx }) => ""
      }
          ...
          >
            ...
            >
              ...
              <ResetPassword
                ...
                onRepeatPasswordChange={async (...eventArgs: any) => {
                  generateStateOnChangeProp($state, [
                    "resetPassword",
                    "repeatPassword"
                  ]).apply(null, eventArgs);
                ...
                repeatPassword={generateStateValueProp($state, [
                  "resetPassword",
                  "repeatPassword"
                ])}
