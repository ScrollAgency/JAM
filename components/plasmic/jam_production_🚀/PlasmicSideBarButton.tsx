...
import sty from "./PlasmicSideBarButton.module.css"; // plasmic-import: QWOZXZk1eTc0/css
...
export type PlasmicSideBarButton__VariantMembers = {
...
export type PlasmicSideBarButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicSideBarButton__VariantsArgs;
export const PlasmicSideBarButton__VariantProps = new Array<VariantPropType>(
  "color",
  "type",
  "size",
  "iconStart",
...
export type PlasmicSideBarButton__ArgsType = {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
type ArgPropType = keyof PlasmicSideBarButton__ArgsType;
export const PlasmicSideBarButton__ArgProps = new Array<ArgPropType>(
  "disabled",
  "submitsForm",
  "resetsForm",
  "ariaLabel",
...
export type PlasmicSideBarButton__OverridesType = {
  root?: Flex__<typeof BaseButton>;
  softBackground?: Flex__<"div">;
  border?: Flex__<"div">;
};

export interface DefaultSideBarButtonProps {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
function PlasmicSideBarButton__RenderFunc(props: {
  ...
  overrides: PlasmicSideBarButton__OverridesType;
  forNode?: string;
}) {
    ...
    >
      ...
      <Stack__
        ...
        className={classNames(projectcss.all, sty.freeBox__xw9Ld, {
          ...
          [sty.freeBoxcolor_success_type_bordered__xw9Ld42OqFHdP5Y]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxiconEnd__xw9LdzuYnl]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__xw9LdspdJ]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxroundedFull__xw9LdVmEjJ]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__xw9LdMQrmH]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__xw9Ld7R14]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__xw9LdmyMuu]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__xw9LdhRuW0]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_actif__xw9Ld2SVuW]: hasVariant(
            $state,
            "type",
            "actif"
          ),
          [sty.freeBoxtype_bordered__xw9LdhdP5Y]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__wQusA, {
            [sty.freeBoxcolor_neutral__wQusAre9UA]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__wQusAre9UAU9B64]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__wQusAspdJ]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__wQusAmQrmH]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__wQusAmyMuu]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__wQusAhRuW0]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_actif__wQusA2SVuW]: hasVariant(
              $state,
              "type",
              "actif"
            ),
            [sty.freeBoxtype_bordered__wQusAhdP5Y]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__utdIi)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__aavnn, {
            [sty.freeBoxiconEnd__aavnnzuYnl]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__aavnnMQrmH]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__aavnnmyMuu]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__aavnnhRuW0]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <PictogramIcon
                className={classNames(projectcss.all, sty.svg__alIi8)}
                role={"img"}
              />
            ),
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicSideBarButton__OverridesType,
  DescendantsType<T>
>;
