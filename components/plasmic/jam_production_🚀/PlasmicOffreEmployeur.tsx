...
function PlasmicOffreEmployeur__RenderFunc(props: {
  ...
  const new$Queries: Record<string, ReturnType<typeof usePlasmicDataOp>> = {
    ...
    stripeUserInfos: usePlasmicDataOp(() => {
      return {
        sourceId: "kVSSe8ab4TtzwRPnTeEeUp",
                      ...
                      >
                        ...
                        >
                          <React.Fragment>
                            {(() => {
                              try {
                                return $queries.currentJobOffers.data[0].salary;
                              } catch (e) {
                                if (
                                  e instanceof TypeError ||
                                  e?.plasmicType === "PlasmicUndefinedDataError"
                ...
                >
                  ...
                  >
                    <React.Fragment>
                      {(() => {
                        try {
                          return $queries.currentJobOffers.data[0].description;
                        } catch (e) {
                          if (
                            e instanceof TypeError ||
                            e?.plasmicType === "PlasmicUndefinedDataError"
                  ...
                  >
                    {(_par =>
                      ...
                      (() => {
                        try {
                          return $queries.currentJobOffers.data[0].benefits
                            .split(",")
            ...
            {(() => {
              ...
              >
                {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                  (() => {
                    try {
                      return $queries.cardJobOffers.data;
                    } catch (e) {
                      if (
                        e instanceof TypeError ||
                        e?.plasmicType === "PlasmicUndefinedDataError"
                            ...
                            $steps["postgresUpdateMany"] = true
                              ? (() => {
                                  const actionArgs = {
                                    dataOp: {
                                      sourceId: "kVSSe8ab4TtzwRPnTeEeUp",
                                      opId: "635de2ef-26f1-46b5-a35e-bc006094a16f",
                                      userArgs: {
                                        variables: [
                                          $state._switch.isSelected
                                            ? Number(
