...
import sty from "./PlasmicTextInput2.module.css"; // plasmic-import: zOxru0RPRI2K/css

import SearchSvg2Icon from "./icons/PlasmicIcon__SearchSvg2"; // plasmic-import: UxDTYc7x8y-Q/icon
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: TutuYwBE-NIF/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvg2Icon
              className={classNames(projectcss.all, sty.svg__nE5V)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__ovbbv)}
              role={"img"}
            />
          ),
