...
import sty from "./PlasmicDeleteAccount2.module.css"; // plasmic-import: Aiz3LwUBdbOf/css
...
export type PlasmicDeleteAccount2__VariantMembers = {
  color:
    | "neutral"
    | "muted"
    | "success"
...
export type PlasmicDeleteAccount2__VariantsArgs = {
...
type VariantPropType = keyof PlasmicDeleteAccount2__VariantsArgs;
export const PlasmicDeleteAccount2__VariantProps = new Array<VariantPropType>(
  "color",
  "type",
  "size",
  "iconStart",
...
export type PlasmicDeleteAccount2__ArgsType = {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
type ArgPropType = keyof PlasmicDeleteAccount2__ArgsType;
export const PlasmicDeleteAccount2__ArgProps = new Array<ArgPropType>(
  "disabled",
  "submitsForm",
  "resetsForm",
  "ariaLabel",
...
export type PlasmicDeleteAccount2__OverridesType = {
  root?: Flex__<typeof BaseButton>;
  softBackground?: Flex__<"div">;
  border?: Flex__<"div">;
};

export interface DefaultDeleteAccount2Props {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
function PlasmicDeleteAccount2__RenderFunc(props: {
  variants: PlasmicDeleteAccount2__VariantsArgs;
  args: PlasmicDeleteAccount2__ArgsType;
  overrides: PlasmicDeleteAccount2__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__b36Ri, {
          [sty.freeBoxcolor_neutral__b36RIxNu5V]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxiconEnd__b36RIv309S]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__b36Ribxm1M]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxroundedFull__b36RiuLei]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__b36RIa5QQs]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__b36RIpabFh]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__b36Ri48Bnv]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__b36RiWbJGh]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__b36Rik1Hc]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__b36Rik1HcQrkOj]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__ovSBk, {
            [sty.freeBoxcolor_neutral__ovSBkxNu5V]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__ovSBkBxm1M]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__ovSBka5QQs]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__ovSBk48Bnv]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__ovSBkWbJGh]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__ovSBkK1Hc]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__ovSBkbvvvvXNu5V]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__hKdLr)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__dVoAt, {
            [sty.freeBoxiconEnd__dVoAtv309S]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__dVoAta5QQs]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__dVoAt48Bnv]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__dVoAtWbJGh]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <PictogramIcon
                className={classNames(projectcss.all, sty.svg__blT)}
                role={"img"}
              />
            ),
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicDeleteAccount2__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicDeleteAccount2__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicDeleteAccount2__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicDeleteAccount2__ArgProps,
          internalVariantPropNames: PlasmicDeleteAccount2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicDeleteAccount2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicDeleteAccount2";
  } else {
    func.displayName = `PlasmicDeleteAccount2.${nodeName}`;
  }
  return func;
}

export const PlasmicDeleteAccount2 = Object.assign(
  // Top-level PlasmicDeleteAccount2 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicDeleteAccount2
    internalVariantProps: PlasmicDeleteAccount2__VariantProps,
    internalArgProps: PlasmicDeleteAccount2__ArgProps
  }
);

export default PlasmicDeleteAccount2;
/* prettier-ignore-end */
