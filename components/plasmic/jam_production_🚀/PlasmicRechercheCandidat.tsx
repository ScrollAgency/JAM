          ...
          <LoadingBoundary
            ...
            loadingState={
              <DataCtxReader__>
                {$ctx => (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__b8Nfv)}
                  >
                    <LoadingComponent
                          ...
                          ? (() => {
                              const actionArgs = {
                                customFunction: async () => {
                                  return (() => {
                                    const city =
                                      $state.locationInput.value?.trim();
                                    const keyWords =
                              ...
                              >
                                ...
                                >
                                  ...
                                  {(() => {
                                    try {
                                      return (
                                        currentItem.cover_letter_file !== null
                                      );
                                    } catch (e) {
                                      if (
                                        e instanceof TypeError ||
