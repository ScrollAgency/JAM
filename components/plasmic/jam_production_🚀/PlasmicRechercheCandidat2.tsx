...
import sty from "./PlasmicRechercheCandidat2.module.css"; // plasmic-import: fX4JMF3dHI8p/css
...
export type PlasmicRechercheCandidat2__VariantsArgs = {};
type VariantPropType = keyof PlasmicRechercheCandidat2__VariantsArgs;
export const PlasmicRechercheCandidat2__VariantProps =
  new Array<VariantPropType>();

export type PlasmicRechercheCandidat2__ArgsType = {};
type ArgPropType = keyof PlasmicRechercheCandidat2__ArgsType;
export const PlasmicRechercheCandidat2__ArgProps = new Array<ArgPropType>();

export type PlasmicRechercheCandidat2__OverridesType = {
...
export interface DefaultRechercheCandidat2Props {}
...
function PlasmicRechercheCandidat2__RenderFunc(props: {
  variants: PlasmicRechercheCandidat2__VariantsArgs;
  args: PlasmicRechercheCandidat2__ArgsType;
  overrides: PlasmicRechercheCandidat2__OverridesType;
  forNode?: string;
}) {
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
            ...
            {(() => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox___7H4TO)}
                  >
                    <FormItemWrapper
                      className={classNames(
                        "__wab_instance",
                        sty.formField__vxVby
                      )}
                      initialValue={""}
                      label={
                        <div
                  ...
                  <Button
                    ...
                    color={"white"}
                      ...
                      <GroupIcon
                        className={classNames(projectcss.all, sty.svg__qfWv7)}
                        role={"img"}
                      />
                    }
                    iconEnd={true}
                ...
                {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                  ...
                  return (
                    ...
                    >
                      ...
                      <XIcon
                        className={classNames(projectcss.all, sty.svg__pMa3X)}
                        onClick={async event => {
                          const $steps = {};
                ...
                {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                  ...
                  return (
                    ...
                    >
                      ...
                      <XIcon
                        className={classNames(projectcss.all, sty.svg__qyBby)}
                        onClick={async event => {
                          const $steps = {};
              ...
              {(() => {
                ...
                >
                  ...
                  >
                    ...
                    >
                      <MagnifyingGlassIcon
                        className={classNames(projectcss.all, sty.svg__wW1N)}
                        role={"img"}
                      />
                    </div>
                    <div
              ...
              {(() => {
                ...
                >
                  ...
                  >
                    ...
                    >
                      <MagnifyingGlassIcon
                        className={classNames(projectcss.all, sty.svg__qyy4)}
                        role={"img"}
                      />
                    </div>
                    <div
          ...
          <Modal
            ...
            content={
              <div className={classNames(projectcss.all, sty.freeBox__ela4Z)}>
                <Iframe
                  className={classNames("__wab_instance", sty.iframe__iQ90Y)}
                  src={(() => {
                    try {
          ...
          <Modal
            ...
            content={
              <div className={classNames(projectcss.all, sty.freeBox__k4Hqt)}>
                <Iframe
                  className={classNames("__wab_instance", sty.iframe__pziAy)}
                  src={(() => {
                    try {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicRechercheCandidat2__OverridesType,
  DescendantsType<T>
>;
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicRechercheCandidat2__ArgProps,
          internalVariantPropNames: PlasmicRechercheCandidat2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicRechercheCandidat2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "rechercehCandidat") {
    func.displayName = "PlasmicRechercheCandidat2";
  } else {
    func.displayName = `PlasmicRechercheCandidat2.${nodeName}`;
  }
  return func;
}

export const PlasmicRechercheCandidat2 = Object.assign(
  // Top-level PlasmicRechercheCandidat2 renders the root element
  makeNodeComponent("rechercehCandidat"),
  {
    ...
    // Metadata about props expected for PlasmicRechercheCandidat2
...
export default PlasmicRechercheCandidat2;
/* prettier-ignore-end */
